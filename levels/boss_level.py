...
def createMapLevel3(brick_array, powerup_array):
    ...
    brick_array.append(RedBrick((FRAME_WIDTH//2) + 1*BRICK_WIDTH, 6, TbPowerUp((FRAME_WIDTH//2) + 1*BRICK_WIDTH, 6)))
    brick_array.append(BlueBrick((FRAME_WIDTH//2) + 2*BRICK_WIDTH, 6, PgPowerUp((FRAME_WIDTH//2) + 2*BRICK_WIDTH, 6)))
    brick_array.append(RedBrick((FRAME_WIDTH//2) + 3*BRICK_WIDTH, 6))
    # layer 4

    brick_array.append(GreenBrick((FRAME_WIDTH//2) - 4*BRICK_WIDTH, 7, SpPowerUp((FRAME_WIDTH//2) - 4*BRICK_WIDTH, 7)))
    #brick_array.append(GreenBrick((FRAME_WIDTH//2) - 3*BRICK_WIDTH, 7, SpPowerUp((FRAME_WIDTH//2) - 3*BRICK_WIDTH, 7)))
    brick_array.append(ExplodingBrick((FRAME_WIDTH//2) - 2*BRICK_WIDTH, 7))
    ...
    brick_array.append(GreenBrick((FRAME_WIDTH//2) + 3*BRICK_WIDTH, 7, EpPowerUp((FRAME_WIDTH//2) + 3*BRICK_WIDTH, 7)))
    ...
    brick_array.append(RedBrick((FRAME_WIDTH//2) + 3*BRICK_WIDTH, 8))
    # layer 2
    brick_array.append(WhiteBrick((FRAME_WIDTH//2) - 2*BRICK_WIDTH, 9))
    brick_array.append(GreenBrick((FRAME_WIDTH//2) - 1*BRICK_WIDTH, 9))
    brick_array.append(GreenBrick((FRAME_WIDTH//2) - 0*BRICK_WIDTH, 9))
    brick_array.append(WhiteBrick((FRAME_WIDTH//2) + 1*BRICK_WIDTH, 9))
    # layer 1
